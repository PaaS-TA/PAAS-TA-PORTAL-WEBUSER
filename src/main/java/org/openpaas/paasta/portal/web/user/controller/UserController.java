...
public class UserController extends Common {
    ...
    public Map updateUser(@PathVariable String userId, @RequestBody Map body) {
        ...
        SsoAuthenticationDetails user = (SsoAuthenticationDetails) oAuth2Authentication.getDetails();
        ...
        OAuth2Authentication authentication = new OAuth2Authentication(oAuth2Authentication.getOAuth2Request(), new UsernamePasswordAuthenticationToken(user, "N/A", oAuth2Authentication.getAuthorities()));
