...
<div class="userinfo">
    ...
    <sec:authorize access="isAuthenticated()">
        <sec:authentication property="details.imgPath" var="imgPath"/>
    </sec:authorize>
    <c:choose>
    ...
    <sec:authorize access="isAuthenticated()">
        <div class="name" id="left_username"><sec:authentication property="details.username" /></div>
    </sec:authorize>

    <div class="dropdown">
        <a class="mail dropdown-toggle" data-toggle="dropdown" id="dropdownTopMenu" href="javascript:void(0);">
            <sec:authorize access="isAuthenticated()">
                <sec:authentication property="details.userid" /><span class="caret"></span>
            </sec:authorize>
        </a>
