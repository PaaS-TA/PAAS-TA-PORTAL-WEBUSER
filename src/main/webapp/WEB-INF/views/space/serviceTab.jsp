    ...
    var fnObj2 = {
        pageStart: function () {
            ...
            myGrid2.setConfig({
                ...
                viewMode: "grid",
                colGroup: [
                    {key: "name", label: "이름", width: "240", align: "center"},
                    {key: "label", label: "제공서비스", width: "180", align: "center"},
                    {key: "update", label: "설정", width: "120", align: "center"}
                ],
...
//                                console.log("this:: " + JSON.stringify(this));
                            ...
                            },
                            {
                                ...
                                if (this.item.dashboardUrl != null && this.item.dashboardUseYn == "Y") {
                                    return "<button type='button' class='btn btn-primary' style='width:120;padding:2px 20px; margin-bottom: 7px;' onclick='popContextMenu2(\"" + this.item.name + "\"," + this.index + ", \"" + this.item.servicePlanName + "\");' style='margin-top: 0px'><b>설정</b></button><br>" + "<button type='button' class='btn btn-primary' style='width:120;padding:2px 20px' onclick='javascript:void(window.open(\""+this.item.dashboardUrl+"\"));'><b>대시보드</b></button>";
                                }else{
                ...
                myGrid2.changeGridView({
                    ...
                    view: {
                        ...
                        format: function () {
                            ...
                            var result = "<table class='table table-striped' border=0>" +
                                    "<tr>" +
                                    "<td>" +
                                    "<ul class='media-list'>" +
                                    "<li class='media'>" +
                            ...
                            if (this.item.dashboardUrl != null && this.item.dashboardUseYn == "Y") {
                                result += "<button type='button' class='btn btn-primary' style='width:120;padding:2px 20px' onclick='javascript:void(window.open(\""+this.item.dashboardUrl+"\"));'><b>대시보드</b></button> &nbsp; ";
                            }
