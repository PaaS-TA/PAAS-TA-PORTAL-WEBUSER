...
<script>
                ...
                contextMenu: {
                    ...
                    menu: [
                        ...
                        },
                        {
                            ...
                            deleteAppModal(this.sendObj.item.name, this.sendObj.item.guid);
                    ...
                    view: {
                        ...
                        format: function () {
                            ...
                            return {
                                ...
                                "<button type='button' class='btn btn-primary' style='width:120;padding:2px 20px' onclick='popContextMenu(\"" + this.item.name + "\",\"" + this.index + "\",\"" + this.item.guid + "\");'><b>설정</b></button> &nbsp; " +
                                "</div>" +
                                "</td>" +
                                "</tr>" +
                                "</table>"
    ...
    function popContextMenu(name, index, guid) {
        AXContextMenu.open({id: "AXGridTargetContextMenu", sendObj: {index: index, item: {name: name, guid: guid}}}, event);
    }
    ...
    function deleteAppModal(name, guid) {
        ...
        $('#modalExecuteBtn').attr("onclick", "deleteApp('" + name + "','" + guid + "')");

        $('#modal').modal('toggle');
    }

    function deleteApp(name, guid) {
        var param = {
            orgName: currentOrg,
            spaceName: currentSpace,
            name: name,
