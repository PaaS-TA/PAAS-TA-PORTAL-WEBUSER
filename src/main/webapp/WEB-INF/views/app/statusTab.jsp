...
<div id="appStatusView" style="display: none;">
    ...
    <table id="appStatusTable" class="event-table" style="display: none;">
        ...
        <tr height="40" style="border:1px solid #dedede;">
            ...
            <th style="border:1px solid #dedede; text-align:center; color:#848383; font-size:17px;">VIEW CHART</th>
        </tr>
        </thead>
...
<script type="text/javascript">
    ...
    var procSetAppStatusTab = function (data) {
        ...
        $.each(data, function (key, dataObject) {
            ...
            htmlString.push('<tr>'
                    ...
                    + '<td class="col-md-1 tac" style="font-size: 15px;color:#979696;">' + resultCpu + ' % </td>'
                    ...
                    + '<td class="col-md-1 tac" style="font-size: 15px;color:#979696;" title="' + procConvertFormatNumber(dataObject.stats.uptime) + ' (sec)">' + resultUptime + ' (min) </td>'
                    ...
                    + '<td class="col-md-2 tac" style="font-size: 15px;color:#979696;"><a href="javascript:void(0);" onclick="procMoveChartView(\'' + key + '\')""><img src="/resources/images/btn_chart.png" /></a></td>'
                    + '</tr>');
        });
    ...
    var procMoveChartView = function(key){
        location.href = "/app/statusChart/" + key;
    };
    ...
    var viewChartPage = function () {
        location.href = "/app/statusChart";
    };
